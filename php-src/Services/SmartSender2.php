 ...
 * @link https://smartsender.io/documentation/api-overview/
 * This service cannot send attachments!
 */
class SmartSender2 implements Interfaces\ISending
{
    protected Interfaces\ILocalProcessing $localProcess;
    protected string $apiPath = "https://api.smartsender.io/send";
    protected string $apiDiscardPath = "https://api.smartsender.io/v2/blacklist/remove";
